...
1. 复制测试数据模板，填入真实凭据：
   ```bash
   cd test/feishu-simulator/test-data/feishu-skills/
   # 编辑每个 JSON 文件，替换 appId、appSecret、userOpenId
   ```
